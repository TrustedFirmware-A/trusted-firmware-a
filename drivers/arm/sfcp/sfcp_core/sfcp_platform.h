 ...
 * \return A platform device structure corresponding to the sending device for the
 *         specified link ID.
 */
struct sfcp_platform_device_t
 ...
 *
 * \param link_id The link ID identifying the communication channel.
 * \return A platform device structure corresponding to the receiving device for the
 *         specified link ID.
 */
struct sfcp_platform_device_t
 ...
 */
void sfcp_platform_get_trusted_subnets(
	struct sfcp_trusted_subnet_config_t **trusted_subnets,
